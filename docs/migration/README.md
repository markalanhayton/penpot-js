...
| [`shared-status.md`](shared-status.md) | Shared modules status — 150 JS files, 1306 assertions, Phase 1 complete |
...
| `backend/` | `server/` | `server/src/` | 🟡 ~85% complete |
| `frontend/` | `client/` | `client/public/` | 🟡 ~80% complete |
| `exporter/` | `server/exporter/` | `server/exporter/src/` | 🟡 ~70% complete |