...
template.innerHTML = `<style>
    ...
    penpot-modal { position: fixed; top: 0; left: 0; right: 0; bottom: 0; z-index: var(--penpot-z-modal, 600); display: none; }
    ...
    penpot-modal[size="small"] .penpot-modal__modal { width: 320px; max-width: calc(100% - 2 * var(--penpot-spacing-l, 16px)); }
    penpot-modal[size="medium"] .penpot-modal__modal, .penpot-modal__modal { width: 480px; max-width: calc(100% - 2 * var(--penpot-spacing-l, 16px)); }
    penpot-modal[size="large"] .penpot-modal__modal { width: 640px; max-width: calc(100% - 2 * var(--penpot-spacing-l, 16px)); }
