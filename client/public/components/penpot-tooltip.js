...
template.innerHTML = `<style>
    ...
    .penpot-tip__tooltip-overlay { position: fixed; z-index: var(--penpot-z-tooltip, 700); pointer-events: none; opacity: 0; transition: opacity var(--penpot-transition-fast, 0.1s ease); }
