...
- Name: p1-workspace.spec.js >> P1: Workspace Shell + View-Only >> workspace renders with toolbar, tools, left sidebar, canvas, and right sidebar
- Location: e2e\p1-workspace.spec.js:14:3
