...
- Name: p3-extended.spec.js >> Boolean Operations and Z-Order >> boolean operations buttons appear when multiple shapes selected
- Location: e2e\p3-extended.spec.js:36:3
