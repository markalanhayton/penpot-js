...
- Name: p1-workspace.spec.js >> P1: Workspace Shell + View-Only >> left sidebar switches between pages, layers, and assets tabs
- Location: e2e\p1-workspace.spec.js:133:3
