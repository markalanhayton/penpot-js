...
- Name: p5-collaboration.spec.js >> P5: Collaboration (WebSocket) >> toolbar has presence bar element before share button
- Location: e2e\p5-collaboration.spec.js:90:3
