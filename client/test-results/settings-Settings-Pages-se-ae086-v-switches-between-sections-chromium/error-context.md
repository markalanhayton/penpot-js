...
- Name: settings.spec.js >> Settings Pages >> settings nav switches between sections
- Location: e2e\settings.spec.js:88:3
...
Call log:
  ...
  - waiting for locator('penpot-settings')
    14 × locator resolved to <penpot-settings section="profile"></penpot-settings>
