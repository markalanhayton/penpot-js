...
- Name: settings.spec.js >> Settings Pages >> feedback form renders
- Location: e2e\settings.spec.js:56:3
...
Call log:
  ...
  - waiting for locator('penpot-settings')
    14 × locator resolved to <penpot-settings section="feedback"></penpot-settings>
