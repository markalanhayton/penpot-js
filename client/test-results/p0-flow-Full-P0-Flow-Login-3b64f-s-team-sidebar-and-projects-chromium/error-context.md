...
- Name: p0-flow.spec.js >> Full P0 Flow: Login → Dashboard → Create File → Workspace >> login → dashboard shows team sidebar and projects
- Location: e2e\p0-flow.spec.js:17:3
